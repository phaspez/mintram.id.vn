...
export default function Decor() {
  return (
    <div
      className="fixed top-0 left-0 w-screen h-screen -z-50 select-none"
      aria-hidden
      role="presentation"
    >
      ...
      <div className="fixed w-[612px] top-[128px] py-4 border-r-12 rotate-5">
        <Marquee className="text-bold text-xl text-gray-600/30 dark:text-gray-400/30">
      ...
      <div className="fixed w-[712px] bottom-[128px] right-0 py-4 border-l-12 -rotate-8">
        ...
        >
          ...
          Reading | I like learning new technologies | Quá ghê gớm |
        </Marquee>
      </div>
